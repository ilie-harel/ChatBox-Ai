...
function VideoEnglish() {
    return (
        <div className="VideoEnglish">
           ...
           <iframe style={{ borderRadius: "20px"}} width="728" height="409.5" src="https://streamable.com/e/mle4ta" frameborder="0"  allowFullScreen={true}  autallow="autoplay"oplay></iframe>
        </div>
    );
}
